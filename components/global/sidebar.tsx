...
import { faBars, faAnglesRight, faHouse, faPersonRunning, faUtensils, faBrain, faHeartCircleBolt, faBullseye, faShuffle, faPeopleGroup, faHandshakeAngle, faGears } from "@fortawesome/free-solid-svg-icons";
...
export default function SideBar (): JSX.Element {
   ...
   return (
      <div className = "absolute">
         <div className = "relative top-0 left-0 translate-x-[20px] translate-y-[1rem] mt-6 ml-[0.3rem] z-10">
            <FontAwesomeIcon
