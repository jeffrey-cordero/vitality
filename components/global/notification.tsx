...
export default function Notification(props: NotificationProps): JSX.Element {
   ...
   return (
      <>
         {visible &&
            <div
               className="absolute w-9/12 sm:w-1/2 min-h-[4.5rem] top-0 left-1/2 transform -translate-x-1/2 max-w-4/5 mx-auto mt-8 opacity-0 notification animate-fadeIn z-20"
               {...props}
            >
