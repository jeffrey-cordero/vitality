...
export function Notification({ status }: { status: SubmissionStatus }): JSX.Element {
   ...
   // TODO --> need to use {status} to determine the message to display
   
   return (
      <>
         {
            <div className={clsx("fixed top-[7.5rem] left-1/2 transform -translate-x-1/2 -translate-y-1/2 py-10", {
               'animate-notificationIn': visible,
               'animate-notificationOut': !visible
            })} ref = {notification}>
               <div className="container">
                  <div className="border-stroke mb-11 flex items-center rounded-md border border-l-[8px] border-l-[#00B078] bg-white p-5 pl-8">
                     ...
                     <div className="flex w-full items-center justify-between">
                        <div>
                           <h3 className="mb-1 text-lg font-medium text-dark">
                        ...
                        <div>
                           <a 
                              className="hover:text-danger hover:cursor-pointer hover:bg-red text-[#ACACB0]"
