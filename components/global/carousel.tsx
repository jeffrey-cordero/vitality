...
export default function Carousel({ items, slideWidth }: { items: JSX.Element[], slideWidth: number }): JSX.Element {
   ...
   return (
      <div className='relative w-full mx-auto bg-white rounded-2xl shadow-2xl my-6'>
         <div
