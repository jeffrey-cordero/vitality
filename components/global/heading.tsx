...
export default function Heading(props: HeadingProps): JSX.Element {
   ...
   return (
      <div className = "relative mx-auto overflow-hidden px-2 text-center sm:px-6">
         ...
         <p className = "mx-auto max-w-[60rem] px-2 text-base font-normal text-gray-500 xxsm:text-base xsm:px-8 sm:px-16 sm:text-lg lg:text-xl xl:px-48 dark:text-gray-400">
            { message }
         </p>
      </div>
   );
