                     ...
                     <div
                        ...
                        <Image
                           ...
                           className = {clsx(
                              ...
                              {
                                 "border-[4px] border-primary shadow-2xl scale-[1.05] transition duration-300 ease-in-out":
                        input.value === source
                              },
                           )}
                           onClick = {(event: React.MouseEvent) => {
                              ...
                              dispatch({
                                 ...
                                 value: {
                                    ...
                                    input: {
                                       ...input,
                                       error:
                            "Failed to fetch your desired image resource. Please ensure the link is valid.",
                                       data: {
                                          ...input.data,
                                          valid: false
                                       }
