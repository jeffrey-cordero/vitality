...
export default function Services(): JSX.Element {
   return (
      <div className = "w-full mx-auto my-4">
         ...
         />
         <div className = "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 justify-center content-center gap-x-[60px] gap-y-[60px] md:gap-y-[60px] w-full sm:w-9/12 mx-auto">
            <Service
               background = "bg-white"
               color = "text-primary"
